...
using SmartCart.DataProvider.Mapper;
...
builder.Services.AddScoped<ICartMemberRepository, CartMemberRepository>();
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    // Настройка поддержки авторизации через Bearer токен
